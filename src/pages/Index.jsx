            ...
            <div className="wrap">
                ...
                <div className="header">
                    <ReactSwipe className="carousel">
                        {
                           this.state.banner_list && this.state.banner_list.map((item, key) => {
                                return (
                ...
                <div className="content">
                    <div className="nav_list flex_wrap">
                        {
                            this.state.first_list && this.state.nav_list.map((item, key) => {
                                return (
                    ...
                    <div className="conduct">
                        <img src={this.state.game_img.img_url} />
                    </div>
                    <div className="new_old_box_max">
                    <div className="new_old_box">
                        <ul className="new_old">
                            {
                                this.state.first_list && this.state.user_item_recommend.item_list.map((item, key) => {
                                    return (
                                        <li className={key > 0 ? 'goods_box goods_active' : 'goods_box'} key={key}>
                                            <img className="goods_img" src={item.base_pic} />
                    ...
                    <div className="activity_cart flex_wrap">
                        <div className="cart_left">
                            <img src={this.state.activity_card.left.pic} />
                        </div>
                        <div className="cart_right">
                            <p className="first_right"><img src={this.state.activity_card.right_top.pic} /></p>
                            <p><img src={this.state.activity_card.right_bottom.pic} /></p>
                        </div>
                    </div>
                    <div className="floor_list">
                        {
                            this.state.item_floor != null && this.state.item_floor.map((item, key) => {
                                return (
                                                ...
                                                item.item_list && item.item_list.map((item, index) => {
                                                    return (
                                                        <li className="goods_child" key={index}>
                                                            <img className="base_pic" src={item.base_pic} />
                ...
                <div className="footer">
                    <div className="foot_nav">
                        {
                            this.state.item_recommend_nav_list && this.state.item_recommend_nav_list.map((item, index) => {
                                return(
